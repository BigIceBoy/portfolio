...
<script type="text/template" id="cacheTemplateRu">
  <div class="hint">
    ...
    <ul class="fa-ul">
      ...
      <% } %>
      <li><span class="fa-li"><i class="fas fa-angle-right"></i></span><a onclick="toggleInstruction(event)" href="#">Очистите кэiiiш из настроек браузера <i class="fas fa-angle-down instruction-collapse-angle"></i></a>
        <div class="gallery">
